...
public class Kabaddi1 extends AppCompatActivity {
    EditText n1,n2;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_kabaddi1);
        setTitle("Kabaddi");
        ...
        b1.setOnClickListener(v -> {
            ...
            Intent inten=new Intent(Kabaddi1.this,Kabaddi1.class);
            inten.putExtra("keyn1",s2);
            inten.putExtra("keyn2",s3);
            startActivity(inten);

            Intent intent=new Intent(Kabaddi1.this,Kabaddi2.class);
