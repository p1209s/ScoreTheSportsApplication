...
import com.example.score.Random.Ran_Randomize;
...
public class NumberOfTeamsDialog extends DialogFragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.ran_numberofteamsdialog, null);
		...
		try{
			...
			if(numberOfTeams < 2){
				...
				if(v.getId() == R.id.bGoRandomize){
					...
					Intent i = new Intent(getActivity(), Ran_Randomize.class);
