...
import com.example.score.Random.Ran_DbHelper;
import com.example.score.R;
import com.example.score.Random.Ran_LoadPreset;
...
public class LoadSavePresetAsDialog extends DialogFragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.ran_saveasdialog, null);
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.bCancelSave){
			...
			Ran_DbHelper db = new Ran_DbHelper(getActivity());
