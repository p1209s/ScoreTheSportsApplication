...
public class Volleyball1 extends AppCompatActivity {
    EditText n1,n2;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        b1.setOnClickListener(v -> {
            ...
            Intent inten=new Intent(Volleyball1.this,Volleyball1.class);
            inten.putExtra("keyn1",s2);
            inten.putExtra("keyn2",s3);
            startActivity(inten);

            Intent intent=new Intent(Volleyball1.this, com.example.score.volleyball.Volleyball2.class);
